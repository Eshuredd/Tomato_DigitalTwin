...
function StandaloneSessionForm() {
  ...
  const form = useForm<SessionInput, unknown, SessionOutput>({ resolver: zodResolver(sessionFormSchema), defaultValues: { planting_date: new Date().toISOString().slice(0, 10), location: { name: "", latitude: "" as never, longitude: "" as never, elevation_m: "" }, soil_texture: "sandy_loam" } });
